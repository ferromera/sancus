...
void AdministratorScreen::draw()
{
	...
	std::cout<<"5- Ejecutar simulacion de votacion"<<std::endl;
	std::cout<<"6- Volver a pantalla principal"<<std::endl;
	std::cout<<"7- Salir de VoteApp"<<std::endl;
	std::cout<<""<<std::endl;
	while(true)
	{
		...
		switch(opcion)
		{
				...
				case 5: app->setActualScreen(SIMUL_SCREEN);return;
				case 6: app->setActualScreen(LOGIN_SCREEN);return;
				case 7: app->setQuit(true);return;
